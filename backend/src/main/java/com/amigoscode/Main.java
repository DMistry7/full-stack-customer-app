...
//            testBucketUploadAndDownload(s3Service, s3Buckets);
    ...
    // note to use test
    // comment out create random customer
    // uncomment test bucket upload and download
    // put S3Service s3Service, S3Buckets s3Buckets in the paramaters for commandline runner


    private static void testBucketUploadAndDownload(S3Service s3Service, S3Buckets s3Buckets) {
        s3Service.putObject(
                s3Buckets.getCustomer(),   // "fs-dm-amigoscode-customer-test"
                "foo/bar/jamilia",
